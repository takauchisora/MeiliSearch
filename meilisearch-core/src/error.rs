...
impl ErrorCode for Error {
    fn error_code(&self) -> Code {
        ...
        match self {
            ...
            Heed(_) | Fst(_) | SerdeJson(_) | Bincode(_) | Serializer(_) | Deserializer(_) | VersionMismatch(_)
            | Io(_) => Code::Internal,
        }
    }
}
...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        match self {
            ...
            VersionMismatch(version) => write!(
                f,
                "Cannot open database, expected MeiliSearch engine version: {}, current engine version: {}.{}.{}",
                version,
    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        match self {
            ...
            UnexpectedToken { expected, found } => {
                write!(f, "unexpected token {}, expected {}", found, expected.join("or"))
            }
            ...
            InvalidDocumentAttribute(attr) => {
                write!(f, "invalid document attribute {}, accepted types: String and [String]", attr)
            }
            NoAttributesForFaceting => {
                write!(f, "impossible to perform faceted search, no attributes for faceting are set")
            }
        }
    }
}
